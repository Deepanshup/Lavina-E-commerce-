...
class WooCommerce_Bulk_Order_Form_Admin_Settings_Options {
	...
	public function settings_fields( $fields ) {
		...
		$fields['general']['general'][] = array(
			...
			'type'       => 'checkbox',
			'default'    => true,
			'label'      => __( 'Exclude out of stock items', WC_BOF_TXT ),
			// 'desc'       => __( 'Exclude out of stock items from search and prepopulated templates', WC_BOF_TXT ),
			'attr'       => array(
				'data-show-label' => true,
				'data-label'      => __( 'Enabled', WC_BOF_TXT ),
				'data-ulabel'     => __( 'Disabled', WC_BOF_TXT ),
				'data-separator'  => '||',
			),
		);
