...
class WooCommerce_Bulk_Order_Form_ShortCode_Handler {
	...
	public function get_db_settings() {
		...
		$db_settings['no_of_rows']               = wc_bof_option( 'no_of_rows',               '2' );
		$db_settings['max_items']                = wc_bof_option( 'max_items',                -1 );
		$db_settings['price_label']              = wc_bof_option( 'price_label',              __( 'Price', WC_BOF_TXT ) );
		$db_settings['product_label']            = wc_bof_option( 'product_label',            __( 'Product', WC_BOF_TXT ) );
		$db_settings['quantity_label']           = wc_bof_option( 'quantity_label',           __( 'Qty', WC_BOF_TXT ) );
		$db_settings['variation_label']          = wc_bof_option( 'variation_label',          __( 'Variation', WC_BOF_TXT ) );
		...
		$db_settings['single_addtocart_label']   = wc_bof_option( 'single_addtocart_label',   __( 'Add To Cart', WC_BOF_TXT ) );
		$db_settings['cart_label']               = wc_bof_option( 'cart_label',               __( 'Add To Cart', WC_BOF_TXT ) );
		$db_settings['total_label']              = wc_bof_option( 'total_label',              __( 'Total', WC_BOF_TXT ) );
