...
function wpcd_product_category_discount() {
    ...
    ?><form enctype="multipart/form-data" method="POST">
        <div class="postbox wc-metaboxes-wrapper" style="width:93%">
            <div><a href="https://www.wooextend.com/woocommerce-expert" target="_blank"><img src="<?php echo plugin_dir_url( __FILE__ ) . 'assets/images/services_banner.jpg';?>" style="width:100%;height:150px;"/></a></div>
...
function wpcd_load_custom_wp_admin_style() {
    ...
    wp_register_style( 'date-picker-css', plugin_dir_url( __FILE__ ) . 'assets/css/jquery.datetimepicker.css' );
