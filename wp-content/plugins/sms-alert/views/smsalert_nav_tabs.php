<ul>
			...
			?>
			 ...
			 <?php	
			  ...
			  { 
			?>
				  <li tab_type="embkcsttemplates" onclick="SMSAlert_change_nav(this, 'SMSAlert_nav_embkcsttemplates_box')" >
					<a href="#embkcsttemplates"><span class="dashicons-before dashicons-admin-users"></span> <?php echo _e( 'EMBooking Cust.', SmsAlertConstants::TEXT_DOMAIN );?></a>
				  </li>
				  
				  <li tab_type="embkadmintemplates" onclick="SMSAlert_change_nav(this, 'SMSAlert_nav_embkadmintemplates_box')" >
					<a href="#embkadmintemplates"><span class="dashicons-before dashicons-list-view"></span> <?php echo _e( 'EMBooking Admin', SmsAlertConstants::TEXT_DOMAIN );?></a>
				  </li>
			 <?php	
			  }
