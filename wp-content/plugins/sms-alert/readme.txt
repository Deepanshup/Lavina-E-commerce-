...
= 3.2.2 =
* Integration with Order Delivery Date for WooCommerce
* Compatibility check for latest woocommerce and wordpress versions

= 3.2.3 =
* Added 2 new hooks support to extend this plugin's functionality and usage sa_before_send_sms and sa_after_send_sms
* Added timeout in wp_remote_post for slower websites compatibility
* compatibility check with latest wordpress and woocommerce versions
* Bugfix: New line char not working in sms templates
* Proper Error message was not displayed when outgoing request is blocked on server
* Contact form 7 OTP not workingwhen multiple forms are there on a page
* Bugfix: woocommerce registration validation error not showing message

= 3.2.4 =
* Added option to manually sync customers to SMS Alert Group
* Added compatibility for multistep checkout plugins
* compatibility check with latest wordpress and woocommerce versions
* Bugfix: Sanitize fields handling for older wordpress versions
* Bugfix: duplicate number message was not displayed at registration page

= 3.2.5 =
* Integration with Events Manager
* Woocommerce Booking - added tokens for Resource Name, and Persons count
* OTP popup design minor changes
* compatibility test with latest woocommerce version
