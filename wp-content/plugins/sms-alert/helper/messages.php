...
{	
	...
	//event manager booking Default Template
	const DEFAULT_EMBK_BUYER_SMS_STATUS_CHANGED = 'Hello [first_name], status of your booking [booking_id] with [store_name] has been changed to [booking_status].';
	const DEFAULT_EMBK_ADMIN_SMS_STATUS_CHANGED = '[store_name]: status of order #[booking_id] has been changed to [booking_status].';
